...
class ArticlesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var vista = inflater.inflate(R.layout.fragment_articles, container, false)

        val recyclerArticulos: RecyclerView = vista.findViewById(R.id.recyclerviewarticulos)
        recyclerArticulos.setHasFixedSize(true)
        recyclerArticulos.layoutManager = GridLayoutManager(context,
            2,
